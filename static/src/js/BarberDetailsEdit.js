odoo.define('point_of_sale.BarberDetailsEdit', function(require) {
    'use strict';
    ...
    class BarberDetailsEdit extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    BarberDetailsEdit.template = 'BarberDetailsEdit';

    Registries.Component.add(BarberDetailsEdit);

    return BarberDetailsEdit;
});
